...
/*Nombre con el que se generara la clase .java*/
%class ALexico_GUI
/*Tipo de la clase*/
%public

/*Genera su propio main*/
%debug

/*Tipo que nos devuelve para los token yylex()*/
%int

/*Nos indica la linea y la columna donde estamos.*/
%line
%column

/*Para que no diferencie mayusculas y minusculas.*/
%ignorecase
